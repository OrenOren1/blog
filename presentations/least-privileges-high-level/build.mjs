...
// - With no flags: runs `slidev build` writing to ../../public/presentations/least-privileges-high-level/,
...
const PUBLIC_OUT = resolve(BLOG_ROOT, "public/presentations/least-privileges-high-level");
const BASE_PATH = "/presentations/least-privileges-high-level/";
